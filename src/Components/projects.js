      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <h3 className="text-3xl font-semibold mb-4">Login and Registration Form</h3>
          ...
          {/* New Project 1 */}
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <h3 className="text-3xl font-semibold mb-4">food website</h3>
            <p className="mb-4"> A food website is a digital platform to share recipes, cooking tips, or information about food products and services. A food web consists of all the food chains in a single ecosystem. .</p>
            <div className="flex justify-center space-x-4">
              <a 
          ...
          {/* New Project 2 */}
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <h3 className="text-3xl text-white    font-semibold mb-4">my-website</h3>
            <p className="mb-4">A portfolio website is a curated, online space that showcases your best work. Much like your PDF portfolio, a portfolio website can be used when applying for jobs or internships.</p>
            <div className="flex justify-center space-x-4">
              <a 
